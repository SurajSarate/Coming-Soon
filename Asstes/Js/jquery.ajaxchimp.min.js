    ...
    u.fn.ajaxChimp = function(e) {
        return u(this).each(function(a, s) {
            ...
            i.submit(function() {
                ...
                u.ajax({
                    ...
                    success: function(s) {
                        if ("success" === s.result)
                            ...
                            try {
                                var a = s.msg.split(" - ", 2);
                                e = void 0 !== a[1] && parseInt(a[0], 10).toString() === a[0] ? (a[0],
                                a[1]) : s.msg
                            } catch (a) {
                                e = s.msg
                            }
                        }
                        "en" !== l.language && void 0 !== u.ajaxChimp.responses[e] && u.ajaxChimp.translations && u.ajaxChimp.translations[l.language] && u.ajaxChimp.translations[l.language][u.ajaxChimp.responses[e]] && (e = u.ajaxChimp.translations[l.language][u.ajaxChimp.responses[e]]),
                        t.html(e),
                        t.show(),
                ...
                var s = "Submitting...";
                return "en" !== l.language && u.ajaxChimp.translations && u.ajaxChimp.translations[l.language] && u.ajaxChimp.translations[l.language].submit && (s = u.ajaxChimp.translations[l.language].submit),
